...
const itemEstilo = {
    ...
    // Flex
    alignItems: 'center',  //trabalha o alinhamento no cross Acess
    flexDirection: 'row',  //main acess para a ser row e nao coluna
    justifyContent: 'space-between',  //trabalha em cima do eixo principal main acess
